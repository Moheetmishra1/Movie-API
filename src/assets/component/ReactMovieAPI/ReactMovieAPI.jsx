...
export default function ReactMovieAPI(){  
    ...
    let [check,setCheck] = useState({loading:"block", found:"none"}) 
...
let fetchSearchButton = async ()=>{     
    ...
    return (
        ...
        <div className="movieList">
            ...
            {check.loading==="none" &&users.map(({Title,Year,Rated,Released,Runtime,Genre,Actors,Poster,Country,Language},index)=>{
